...
> "Flight Control can send methodology feedback upstream to the mission-control plugin as GitHub issues — raised after a mission debrief, generalized so no project information leaves this repository, and never sent without your approval of the exact text. Enable that channel for this project?"
